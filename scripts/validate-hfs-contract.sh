...
require_grep 'QWENPAW_SOURCE_REF=a15a69fca73e67c17dc47326e933eaa259fa0d8d' Dockerfile "Dockerfile must default to the requested upstream source commit"
require_grep 'QWENPAW_SOURCE_VERSION=2\.0\.0\.post3' Dockerfile "Dockerfile must default to the requested upstream source version"
